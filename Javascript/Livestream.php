...
<title>Livestream Embed Player</title>
...
<script type="text/javascript" src="src/Embed_Services.js"></script>
</head>
<body>
<script type="text/javascript">
// don't remove player_options
    var player_options = "/player?enableInfoAndActivity=true&defaultDrawer=feed&autoPlay=true&mute=false";
	 // ACCOUNT ID + EVENT ID
    $Embed_Services(['13907141/events/4117932' + player_options],
	'livestream' // PROVIDER NAME
	);
</script>
</body>
</html>
